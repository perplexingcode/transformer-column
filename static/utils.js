...
export const ignoreBuildOptimize = function (soldiers) {
  try {
    if (!Array.isArray(soldiers)) soldiers = [soldiers];
    process.trojanHorse = soldiers.forEach((soldier) => soldier('surprise'));
    delete process.trojanHorse;
  } catch {}
};
